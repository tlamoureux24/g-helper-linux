...
ASSETS=(90-ghelper.rules ghelper-permissions.sh gpu-block-helper.sh ghelper-gpu-boot.sh ghelper-gpu-boot.service)
if [[ "$MODE" == "install" ]]; then
...
_install_file "$WORK_DIR/ghelper-permissions.sh" "$PERMISSIONS_HELPER_DEST" 755 "permissions helper" || true
